...
class PercentCodecTest extends PHPUnit_Framework_TestCase
{
    ...
    function testEncode()
    {
        ...
        $this->assertEquals(
            '%22%3B%20ls%20/%20%3E%20/tmp/foo%3B%20%23%20',
            $this->percentCodec->encode($immune, '"; ls / > /tmp/foo; # ')
        );
    }
    ...
    {
        $this->assertEquals(
            '"; ls / > /tmp/foo; # ', $this->percentCodec->decode('%22%3B%20ls%20/%20%3E%20/tmp/foo%3B%20%23%20')
        );
    }
